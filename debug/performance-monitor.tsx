        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-1">
              ...
              <Button onClick={clearLogs} size="sm" variant="ghost" className="h-7 px-2 text-xs">
                Clear
              </Button>
              <Button
          ...
          <div className="flex gap-2 mt-2 text-xs">
            ...
            {deviceInfo.network && <Badge variant="outline">{deviceInfo.network}</Badge>}
          ...
          <CardContent className="pt-0">
                ...
                logs.map((log, index) => (
                  ...
                  >
                    ...
                    <div className="flex-1 break-all">
                      ...
                      {log.duration && (
                        <span className="ml-1 text-green-600 font-semibold">{log.duration}</span>
                      )}
                    </div>
                  </div>
                ))
            ...
            {logs.some((l) => l.type === "summary") && (
              <div className="mt-3 pt-3 border-t">
                ...
                {logs
                  .filter((l) => l.type === "end" || l.type === "summary")
                  .map((log, index) => (
